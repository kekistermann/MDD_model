...
My computational is based on the causal loop diagram of MDD proposed in:
...
And in the approach to model the functional relationshipgs of the proposed causal loop diagram, my attempt is influenced by: 
